...
create_covid_data_targets <- function() {
  ...
  rlang::list2(
    ...
    tar_target(
      ...
      command = {
        if (skip_veteran) {
          message("SKIP_VETERAN_DATA=1 detectado: omitiendo veteran_state_archive (covid).")
          return(NULL)
        }
    ...
    tar_target(
      ...
      command = {
        ...
        if (!skip_veteran) {
          ...
          message("SKIP_VETERAN_DATA=1 detectado: omitiendo merge con veteran_state_archive (covid).")
        }
